...
module.exports = {
  ...
  sign: function(prvkey, msg) {
    ...
    var vrs = utils.ecsign(new Buffer(this.soliditySha3(msg),"hex"), new Buffer(prvkey, "hex"));
    return utils.toRpcSig(vrs.v, vrs.r, vrs.s);
  },

  verify: function(pubkey, msg, rpcSig) {
    var vrs = utils.fromRpcSig(rpcSig);
    var pubaddr = utils.bufferToHex(utils.pubToAddress(utils.ecrecover(new Buffer(this.soliditySha3(msg),"hex"), vrs.v, vrs.r, vrs.s)));
